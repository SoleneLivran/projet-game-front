...
const UserPanel = ({ isLogged, connectedId, username }) => {
  ...
  return (
    <div className="user-panel h-24 w-full bg-gray-900 text-white flex items-center justify-between rounded-l-full md:flex-col md:rounded-lg md:relative md:justify-center md:text-center">
      ...
      <p className="user-panel__content w-48 ml-4 mr-auto text-xl font-bold md:mt-16 md:mr-0 md:ml-0 md:mb-6">
        Bienvenue, <br /> <span>{nameToDisplay}.</span>
      </p>
