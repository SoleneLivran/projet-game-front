...
const Story = () => (
  <li className="stories__story mx-auto my-4 h-16 px-4 bg-gray-100 rounded-md flex justify-between items-center">
    <h2 className="stories__story-title overflow-auto h-12 py-3">Nom de l'histoire</h2>
